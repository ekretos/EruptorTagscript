...
description: Learn how Eruptor combines TagScript with Lavalink audio to turn your Discord server into an automated, interactive music hub.
---
...
- **Matching Priority:** Exact phrase match &rarr; First word match &rarr; Keyword match.
...
- Check out the [Quickstart Guide](/getting-started/quickstart/) to create your first tag in 60 seconds.
- Learn the TagScript [Syntax & Anatomy](/getting-started/syntax-and-anatomy/).
