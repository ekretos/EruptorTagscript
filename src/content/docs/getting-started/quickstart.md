...
description: Follow this step-by-step tutorial to create and deploy interactive tags and music triggers in Eruptor.
---
...
## Continue Reading
Learn the core syntax rules in the [Syntax & Anatomy Guide](/getting-started/syntax-and-anatomy/).
